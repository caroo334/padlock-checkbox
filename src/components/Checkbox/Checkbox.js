...
import { Input, StyledLabel, ButtonLockContainer } from './Checkbox.styles';

const ButtonLock = ({ isValid }) => {
  ...
  return (
    <>
      <Input id="inpLock" type="checkbox" onChange={handleInputChange} checked={checked} />
      <StyledLabel htmlFor="inpLock" checked={checked} className="btn-lock">
        <ButtonLockContainer>
